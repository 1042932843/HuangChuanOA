...
public class EditCalendarActivity extends BaseActivity {
    Handler handler=new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            try {
                ...
                ToastUtil.showShort(EditCalendarActivity.this,""+message);
                if (success){
                    finish();
                }
            }catch (Exception e){
    ...
    private void initDate() {
        ...
        status.setText(getIntent().getStringExtra("status").replace("状态：",""));
    ...
    void start_time() {
        TimePickerView pvTime = new TimePickerView.Builder(EditCalendarActivity.this, new TimePickerView.OnTimeSelectListener() {
            @Override
...
//                        .isDialog(true)//是否显示为对话框样式
    ...
    @OnClick(R.id.status)
    void setStart_time() {
        OptionsPickerView pvOptions = new OptionsPickerView.Builder(EditCalendarActivity.this, new OptionsPickerView.OnOptionsSelectListener() {
            @Override
...
//                        .isDialog(true)//是否显示为对话框样式
    ...
    void update_userinfo(){
        ...
        calendarControl.editCalendarInfo(userId,pkId,contentS,etime,stime,statusS,titleS);
    }
    class CalendarControl extends Ok {
        ...
        public void editCalendarInfo(String userId,String pkId,String content, String endTime, String startTime, String status, String title) {
            super.post(Constant.DOMAIN + "mobile/confernceMobile/AppPlanTaskUpdate.do", "userId", userId,"pkId",pkId, "content", content,
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            Log.d("reg", "result:" + re);
            App.me().checklogin(EditCalendarActivity.this, re);
            // JSON串转用户对象列表
            try {
                //发消息更新UI
